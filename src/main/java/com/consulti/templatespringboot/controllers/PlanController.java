...
public class PlanController {
    ...
    public ResponseEntity <Boolean> deleteUser(@PathVariable Long planId) throws Exception {
      
      return ResponseEntity.status(HttpStatus.OK).body(true);
    }
  
    @PostMapping("/save_payment")
    public ResponseEntity<PlanModel> savePayment(@RequestBody PlanModel newPlan) throws Exception {
