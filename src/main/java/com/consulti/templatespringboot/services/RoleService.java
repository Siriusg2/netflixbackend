...
public class RoleService implements RoleRepository {
    ...
    @Override
    public <S extends RolesModel> Page<S> findAll(Example<S> example, Pageable pageable) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findAll'");
    }
    ...
    @Override
    public <S extends RolesModel, R> R findBy(Example<S> example, Function<FetchableFluentQuery<S>, R> queryFunction) {
        // TODO Auto-generated method stub
